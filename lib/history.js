...
const scrollBehaviour = new ScrollBehaviour(history.location);

export const storeScroll = scrollBehaviour.storeScroll;
export const restoreScroll = scrollBehaviour.restoreScroll;
